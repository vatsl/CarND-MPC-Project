...
const double ref_v = 30.0 * 0.44704; // in m/s
...
vector<double> MPC::Solve(Eigen::VectorXd state, Eigen::VectorXd coeffs) {
  ...
  //
  // Initialize the constraints and vars
  // length: In our case state length=6, and there are 2 actuators
  ...
  //
  // vars value: Initial value of the independent variables. should be 0 besides initial state.
  Dvector vars(n_vars);
